...
public class EmailServer {
	...
	private static void doSend(String[] mailbox, int messagesInBox, Scanner input) {
		/*
		 * Client has requested 'sending', so server must read message from this client
		 * and then place message into messae box for other client (if there is room).
		 */
	...
	private static void doRead(String[] mailbox, int messagesInBox, PrintWriter output) {
		 ...
		 */
		System.out.println("\nSending " + messagesInBox + " messsage{s).\n");
...
class InvalidClientException extends Exception {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4652806592204111882L;
...
class InvalidRequestException extends Exception {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5962900686788940720L;
