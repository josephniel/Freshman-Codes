...
public class _LostMyPieces implements Song{
	...
	public void play() {
		...
		+ "I[Atmosphere] B5q C6q E5w+G5w+D6i E6i D6i G6i F#6i D6i A5i E6i D5h+F#5h+A5h+D6h A5q C6q E5w+G5w+B5i C6i B5i E6i D6i G5i A5i C6i B5h "
		...
		song.play(finalPattern);
		
		try {
			song.saveMidi(finalPattern, new File("Toradora - LostMyPieces.midi"));
		} catch (IOException e) {
