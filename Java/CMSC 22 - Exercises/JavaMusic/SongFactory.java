...
public class SongFactory{
	...
	public static Song getSong(String songTitle){
		...
		// Marquee's (Chocolate Pepperoni)
		case "out of my league":
			song = new _OutOfMyLeague();
			break;
		
		// Joseph's (Chocolate Pepperoni)
		case "how to save a life":
...
class JustTheWayYouAre implements Song{
	...
	public void play(){	
		...
		player.play(song);
		try {
			player.saveMidi(song, new File("just the way you are.midi"));
		} catch (IOException e) {
