...
public class _Payphone implements Song{
	...
	private void playPayphone()
	{
		...
		Pattern right = new Pattern("T[100] I[Piano] V1 " 
				...
				+ "E4q B4q E5h " + "B3q F#4q B4h " + "G#3q D#4q G#4h " + "F#3q C#4q F#4h " + "E3w"
				);	
		...
		player.play(song);
		try {player.saveMidi(song, new File("Payphone - Maroon5.midi"));} 
