<div class='opSearchFunction searchFunction'>
	
	<form method='post' class='opSearchSubmit'>
	...
	<div class='tableFormat'>
		<div class='row tableHeaderRow move'>
			...
			<div class='column4 column tableHeader'>Available</div>
			<div class='column1 column tableHeader'>Price</div>
		</div>
